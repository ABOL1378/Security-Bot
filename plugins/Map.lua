...
local function run(msg, matches)
	...
	elseif matches[1] == "link" then
		return "Ù…ÙˆÙ‚Ø¹ÙŠØª Ù…Ú©Ø§Ù†ÙŠ Ø¯Ø± Ú¯ÙˆÚ¯Ù„ Ù…Ù¾:\nhttps://www.google.com/maps/place/" .. lat .. "," .. lng
	elseif matches[1] == "gps" then
		return "Ù…Ø®ØªØµØ§Øª Ù…Ø­Ù„ Ù…ÙˆØ±Ø¯ Ù†Ø¸Ø±:\n"..lat..","..lng
	end
	return nil
end
...
return {
	...
	usage = {
		"map loc (name) : Ù„ÙˆÚ©ÙŠØ´Ù†",
		"map link (name) : Ù„ÙŠÙ†Ú© Ú¯ÙˆÚ¯Ù„ Ù…Ù¾",
		"map map (name) : Ù†Ù‚Ø´Ù‡",
		"map view (name) : ØªØµÙˆÙŠØ± ÙˆØ§Ù‚Ø¹ÙŠ",
		"map gps (name) : Ù…Ø®ØªØµØ§Øª",
	},
	patterns = {
		"^[Mm]ap (loc) (.*)$",
		"^[Mm]ap (map) (.*)$",
